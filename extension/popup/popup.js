...
new (class ExtensionPopup {
  ...
  createNewIssue(forcingValue, accountValue) {
    ...
    issueBody +=
      "\n---\n\n*This request was generated automatically from the FluentFox extension.*";
  ...
  createBugReportBodyForType(bugType, data) {
    ...
    body += `- **Firefox Version:** <!-- Please specify your Firefox version -->\n`;
    body += `- **Platform:** ${
